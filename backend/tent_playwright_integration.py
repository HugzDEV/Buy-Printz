...
class TentPlaywrightIntegration:
    def __init__(self):
        ...
        self.product_pages = {
            'tent_10x10': 'https://www.b2sign.com/event-tent-canopy-graphic',
            'tent_10x15': 'https://www.b2sign.com/event-tent-canopy-graphic',
            'tent_10x20': 'https://www.b2sign.com/event-tent-canopy-graphic'
        }
