...
class TentPlaywrightIntegration(B2SignPlaywrightIntegration):
    ...
    async def _fill_banner_quote_form(self, order_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Step 4: Select Blind Drop Ship (USE PROVEN BANNER METHOD)
            await self._select_blind_drop_ship()
            
            # Step 5: Open address modal and fill customer address (USE PROVEN BANNER METHOD)
            await self._open_and_fill_address_modal(zip_code, customer_info)
            
            # Step 6: Extract all shipping options (USE PROVEN BANNER METHOD)
    ...
    # Inherited from B2SignPlaywrightIntegration - using proven banner methods
