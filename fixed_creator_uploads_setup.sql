-- FIXED CREATOR UPLOADS SETUP
-- Corrected column references for user_profiles table
...
-- Basic RLS policies (fixed column references)
...
-- Fixed admin policy - check if user is admin
