          ...
          {previewImage ? (
            <>
              <img
                src={previewImage}
                alt="Design Preview"
                className="max-w-full max-h-full object-contain select-none origin-center scale-[1.98] sm:scale-[1.2] translate-x-[28px] translate-y-[12px] sm:translate-x-[12px] sm:translate-y-[6px]"
