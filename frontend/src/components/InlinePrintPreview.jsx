  ...
  return (
    <div className="space-y-4">
      <div className="w-full bg-white rounded-lg border border-gray-200 p-3">
        ...
        <div className="relative w-full h-[300px] sm:h-[420px] lg:h-[520px] bg-white rounded-md overflow-hidden flex items-center justify-center">
          {previewImage ? (
            <>
              <img
                src={previewImage}
                alt="Design Preview"
                className="max-w-full max-h-full object-contain select-none origin-center scale-[1.35] sm:scale-100"
