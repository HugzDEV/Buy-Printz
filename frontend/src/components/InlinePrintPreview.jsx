          ...
          {previewImage ? (
            <>
              <img
                src={previewImage}
                alt="Design Preview"
                className="max-w-full max-h-full object-contain select-none origin-center scale-[1.98] sm:scale-100 translate-x-[28px] translate-y-[12px] sm:translate-x-0 sm:translate-y-0"
