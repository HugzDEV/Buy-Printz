...
const BannerCanvas = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gradient-to-br from-gray-50 to-gray-100 relative">
      ...
      <div className={`absolute top-10 sm:top-20 left-0 right-0 bottom-4 md:bottom-20 flex items-start justify-center p-1 sm:p-2 overflow-hidden transition-all duration-300 ease-in-out`}>
