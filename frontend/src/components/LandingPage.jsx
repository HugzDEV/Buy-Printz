...
const LandingPage = () => {
  ...
  // Product ItemList schema for homepage only
  const productItemListSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "BuyPrintz Featured Products",
    "description": "Professional business branding solutions",
    ...
    "itemListElement": [
      {
        ...
        "item": {
          "@type": "Product",
          "@id": "https://www.buyprintz.com/#homepage-business-cards",
          "name": "Business Cards",
          "description": "Unique business cards that get kept, not thrown away. Premium aluminum tins with custom designs.",
          ...
          "brand": { "@type": "Brand", "name": "BuyPrintz" },
          "offers": {
            "@type": "AggregateOffer",
            "lowPrice": "399.99",
            "highPrice": "899.99",
      ...
      },
      {
        ...
        "item": {
          "@type": "Product",
          "@id": "https://www.buyprintz.com/#homepage-banners",
          "name": "Custom Banners",
          "description": "Professional custom banners and vinyl banners for indoor and outdoor use. Weather-resistant, vibrant colors.",
      ...
      },
      {
        ...
        "item": {
          "@type": "Product",
          "@id": "https://www.buyprintz.com/#homepage-tents",
          "name": "Custom Tents",
          "description": "Custom printed tents for events, trade shows, and outdoor vendors. Pop-up canopy tents with vibrant graphics.",
          ...
          "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.9", "reviewCount": "189" }
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          "@type": "Product",
          "@id": "https://www.buyprintz.com/#homepage-stickers",
          "name": "Custom Stickers",
          "description": "Professional vinyl stickers in 8 shapes with Roland premium materials. Die-cut, kiss-cut, and custom gang sheets available.",
          ...
          "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "423" }
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          "@type": "Product",
          "@id": "https://www.buyprintz.com/#homepage-tin-skinz",
          "name": "Tin Skinz",
          "description": "Pre-designed candy tins for every occasion - weddings, birthdays, holidays, and special events.",
