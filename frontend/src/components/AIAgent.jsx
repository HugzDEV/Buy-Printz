...
const AIAgent = ({ onDesignGenerated, onDesignModified, currentDesignId }) => {
  ...
  if (!isOpen) {
    return (
      <div className="fixed bottom-6 right-6 z-10 !important transition-all duration-300" style={{ zIndex: 10 }}>
        <GlassButton
  ...
  return (
    <div className="fixed bottom-6 right-6 z-10 !important w-96 max-h-[600px] transition-all duration-300" style={{ zIndex: 10 }}>
