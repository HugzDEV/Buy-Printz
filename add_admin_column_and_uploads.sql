-- ADD ADMIN COLUMN AND CREATOR UPLOADS
-- First adds is_admin column, then sets up creator uploads with proper admin checking

-- Step 1: Add is_admin column to user_profiles
ALTER TABLE user_profiles 
ADD COLUMN IF NOT EXISTS is_admin BOOLEAN DEFAULT FALSE;

-- Step 2: Create creator uploads table
...
-- Step 4: RLS policies with admin checking
